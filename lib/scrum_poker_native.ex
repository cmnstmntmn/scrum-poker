defmodule ScrumPokerNative do
  ...
  import ScrumPokerWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {ScrumPokerWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([ScrumPokerWeb, CoreComponents, plugin.module_suffix])
